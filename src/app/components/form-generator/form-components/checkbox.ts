...
@Component({
  ...
  <div class="form-group" [formGroup]="parentGroup">
    <div class="checkbox">
    <label>
      <input type="checkbox" id="{{data.labelText}}" [formControlName]="data.formControlName"
...
export class CheckboxComponent extends BaseComponent implements FormComponent, OnInit {
